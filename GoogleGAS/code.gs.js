...
function doPost(e) {
  ...
  try {
    ...
    const rowData = HEADERS.map(header => {
      ...
      return value || ''; // Use empty string for null, undefined, or empty string values
    });
...
function sendApplicantEmail(data) {
  ...
  body += `
    ...
    <p><strong>Read Now:</strong> <a href="https://docs.google.com/document/d/1bcFQqoVxUZUtMcK8GgXE7tqyTAF2-p9Iwq2Ug3bj_fQ/edit?usp=sharing">What to do After your submission</a></p>
